...
(`scripts/demo-account.mjs`): `revisao@marble.pt`; a password está em
`docs/store/acesso-revisao.local.md` (fora do git — rodada a 2026-09-14 depois
de o repositório ter estado público com a anterior),
consentimento na versão legal atual, um carro com checkup pendente, um chão
em dia e dois alertas. Se a password mudar, corre o script outra vez com
`--apply` e atualiza o ficheiro local e as duas consolas. Nos textos abaixo,
substitui `<password>` pela do ficheiro local ao colar nas consolas. Texto:
