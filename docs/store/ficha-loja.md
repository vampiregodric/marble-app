...
`--apply` e atualiza aqui e nas duas consolas. Texto:

```
Início, Portfólio, Serviços e Eventos não pedem conta. Perfil e Alertas pedem
login (email/password). Conta de teste: revisao@marble.pt / Marble-Revisao-2026!. A conta tem um
...
Alerts require login (email/password). Test account: revisao@marble.pt / Marble-Revisao-2026!.
